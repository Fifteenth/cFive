...
function dTree(objName) {
	...
	this.icon = {empty:"images/outlook/empty.jpg", line:"images/outlook/line.jpg", join:"images/outlook/join.jpg", joinBottom:"images/outlook/joinbottom.jpg", plus:"images/outlook/plus.jpg", plusBottom:"images/outlook/plusbottom.jpg", minus:"images/outlook/minus.jpg", minusBottom:"images/outlook/minusbottom.jpg", nlPlus:"images/outlook/nolines_plus.gif", nlMinus:"images/outlook/nolines_minus.gif"};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
...
//	alert(nodeId+":"+node.id+":"+node.pid+":"+node.name+":"+node._ai);
	...
	if(node.pid==this.root.id){
		str += "<div class=\"left_menue_words\"><span>"+node.name+"</span></div>";
	}else{
		str += node.name;
	}
