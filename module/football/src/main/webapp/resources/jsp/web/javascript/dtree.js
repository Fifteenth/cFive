...
function forwardMoveModule(root, method) {
	if (isSomeNodeSelected(root)) {
		alert("请选择要移动的模块");
		return;
	} else {
		var url = "modules.do?method=moveModule&id=" + getSelectedId(root) + "&direction=" + method;
		location.href = url;
	}
}
